...
namespace DevExpress.MyControl
{
    public class MyGridView : GridView
    {
        ...
        protected override int CalcRealViewHeight(System.Drawing.Rectangle viewRect, bool reduceHeightOnly = true)            
        {
            int result = base.CalcRealViewHeight(viewRect, reduceHeightOnly);
