	...
	Partial Public Class CarsDBDataSet
		...
		Partial Public Class CustomersRow
			...
			Public Property CustomerID() As Integer
				Get
					Return (CInt(Fix(Me(Me.tableCustomers.CustomerIDColumn))))
				End Get
		...
		Partial Public Class OrdersRow
			...
			Public Property CustomerID() As Integer
				Get
					Try
						Return (CInt(Fix(Me(Me.tableOrders.CustomerIDColumn))))
					Catch e As Global.System.InvalidCastException
			...
			Public Property CompanyName() As String
				Get
					Try
						Return (CStr(Me(Me.tableOrders.CompanyNameColumn)))
					Catch e As Global.System.InvalidCastException
...
Namespace WindowsApplication1.CarsDBDataSetTableAdapters
	...
	Partial Public Class CustomersTableAdapter
		...
		Public Overridable Function Delete(ByVal Original_CustomerID As Integer, ByVal Original_CompanyName As String) As Integer
			Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Fix(Original_CustomerID)))
		...
		Public Overridable Function Update(ByVal CompanyName As String, ByVal Original_CustomerID As Integer, ByVal Original_CompanyName As String) As Integer
			...
			End If
			Me.Adapter.UpdateCommand.Parameters(1).Value = (CInt(Fix(Original_CustomerID)))
			If (Original_CompanyName Is Nothing) Then
	...
	Partial Public Class OrdersTableAdapter
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Delete, True)> _
		Public Overridable Function Delete(ByVal Original_OrderID As Integer, ByVal Original_CustomerID As Global.System.Nullable(Of Integer), ByVal Original_CompanyName As String) As Integer
			Me.Adapter.DeleteCommand.Parameters(0).Value = (CInt(Fix(Original_OrderID)))
			If (Original_CustomerID.HasValue = True) Then
				Me.Adapter.DeleteCommand.Parameters(1).Value = (CObj(0))
				Me.Adapter.DeleteCommand.Parameters(2).Value = (CInt(Fix(Original_CustomerID.Value)))
			Else
				Me.Adapter.DeleteCommand.Parameters(1).Value = (CObj(1))
				Me.Adapter.DeleteCommand.Parameters(2).Value = Global.System.DBNull.Value
			End If
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, True)> _
		Public Overridable Function Insert(ByVal CustomerID As Global.System.Nullable(Of Integer), ByVal CompanyName As String) As Integer
			If (CustomerID.HasValue = True) Then
				Me.Adapter.InsertCommand.Parameters(0).Value = (CInt(Fix(CustomerID.Value)))
			Else
				Me.Adapter.InsertCommand.Parameters(0).Value = Global.System.DBNull.Value
			End If
			If (CompanyName Is Nothing) Then
		...
		<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"), Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, True)> _
		Public Overridable Function Update(ByVal CustomerID As Global.System.Nullable(Of Integer), ByVal CompanyName As String, ByVal Original_OrderID As Integer, ByVal Original_CustomerID As Global.System.Nullable(Of Integer), ByVal Original_CompanyName As String) As Integer
			If (CustomerID.HasValue = True) Then
				Me.Adapter.UpdateCommand.Parameters(0).Value = (CInt(Fix(CustomerID.Value)))
			Else
				Me.Adapter.UpdateCommand.Parameters(0).Value = Global.System.DBNull.Value
			End If
			If (CompanyName Is Nothing) Then
			...
			If (Original_CustomerID.HasValue = True) Then
				...
				Me.Adapter.UpdateCommand.Parameters(4).Value = (CInt(Fix(Original_CustomerID.Value)))
			Else
